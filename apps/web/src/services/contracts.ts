...
export type CitationVO = Schemas["CitationVO"];
...
export type WeakPointVO = Schemas["WeakPointVO"];
export type TeacherClassroomVO = Schemas["TeacherClassroomVO"];
export type TeacherStudentVO = Schemas["TeacherStudentVO"];
...
export type InterventionRecommendationVO = Schemas["InterventionRecommendationVO"];
export type StudentAttributionExampleVO = Schemas["StudentAttributionExampleVO"];
export type StudentAttributionVO = Schemas["StudentAttributionVO"];
...
export type BulkSuggestionRequest = Schemas["BulkSuggestionRequest"];
export type BulkSuggestionResultVO = Schemas["BulkSuggestionResultVO"];
