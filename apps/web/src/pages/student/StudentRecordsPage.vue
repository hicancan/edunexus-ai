...
const dateRangeInputProps = {
  id: "records-date-range",
  name: "recordsDateRange",
  "aria-label": "做题记录时间区间"
};
...
const columns: DataTableColumns<ExerciseRecordVO> = [
  ...
  },
  {
    ...
    align: "center",
    render(row) {
      return h(NSpace, { align: "center", justify: "center", size: 4 }, () => [
...
<template>
  <div class="records-page">
    <n-space vertical :size="16">
      ...
      <n-alert v-if="exerciseStore.recordsError" type="error" :show-icon="true">{{
        exerciseStore.recordsError
      }}</n-alert>
