...
export interface paths {
    ...
    "/student/exercise/wrong-questions/{questionId}/socratic-probe": {
        ...
        put?: never;
        /** 基于错题触发苏格拉底式提问 */
        post: operations["triggerSocraticProbe"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/student/profile/knowledge-topology": {
        ...
        /** 获取学生知识点拓扑图数据 */
        get: operations["getStudentKnowledgeTopology"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/student/profile/weak-points": {
        ...
        /** 获取学生薄弱知识点聚合 */
        get: operations["getStudentWeakPoints"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/teacher/classrooms": {
        ...
        /** 获取教师可用班级列表 */
        get: operations["listTeacherClassrooms"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/teacher/interventions/recommendations": {
        ...
        /** 获取干预建议聚合列表 */
        get: operations["listInterventionRecommendations"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/teacher/interventions/sandbox": {
        ...
        put?: never;
        /** 教学干预沙盒投递接口 */
        post: operations["sandboxIntervention"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/teacher/students/{studentId}/attribution": {
        ...
        /** 获取学生错因归因摘要 */
        get: operations["getStudentAttribution"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/teacher/suggestions/bulk": {
        ...
        put?: never;
        /** 批量下发教师建议 */
        post: operations["bulkCreateTeacherSuggestion"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        AiQuestionSessionVO: {
            ...
            /**
             * Format: uuid
             * @description 最近一次提交记录 ID；未提交时为空
             */
        ...
        /** @description 学生错因归因摘要 */
        StudentAttributionVO: {
            knowledgePoint?: string | null;
            impactCount?: number;
            summary?: string | null;
            examples?: components["schemas"]["StudentAttributionExampleVO"][];
        };
        /** @description 教师建议 */
        TeacherSuggestionVO: {
            /** Format: uuid */
...
export interface operations {
    ...
    listTeacherClassrooms: {
        ...
        requestBody?: never;
        responses: {
            /** @description 查询成功。data → TeacherClassroomVO 数组 */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    listTeacherStudents: {
        ...
        requestBody?: never;
        responses: {
            /** @description 查询成功。data → TeacherStudentVO 数组 */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    listInterventionRecommendations: {
        ...
        requestBody?: never;
        responses: {
            /** @description 查询成功。data → InterventionRecommendationVO 数组 */
            200: {
                headers: {
                    [name: string]: unknown;
                };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                     ...
                     *         "shareUrl": "/api/v1/teacher/plans/shared/<share-token>"
                     *       },
                     *       "traceId": "trace-xxx",
                     *       "timestamp": "2026-02-26T10:00:00Z"
                     *     }
    ...
    getStudentAttribution: {
        ...
        requestBody?: never;
        responses: {
            /** @description 查询成功。data → StudentAttributionVO */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    bulkCreateTeacherSuggestion: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["BulkSuggestionRequest"];
            };
        };
        responses: {
            /** @description 下发成功。data → BulkSuggestionResultVO */
            200: {
                headers: {
                    [name: string]: unknown;
                };
