...
export const routes: RouteRecordRaw[] = [
  { path: "/", redirect: "/login" },
  {
    path: "/login",
    component: LoginPage,
    meta: { requiresAuth: false, requirementId: "R-AUTH-03", title: "登录" }
  },
  {
    path: "/register",
    component: RegisterPage,
    meta: { requiresAuth: false, requirementId: "R-AUTH-01", title: "注册" }
  },
