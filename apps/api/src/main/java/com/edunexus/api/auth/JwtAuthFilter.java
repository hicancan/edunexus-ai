...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    /** S-02: URL 前缀角色网关 — 自动强制 /student/ → STUDENT, /teacher/ → TEACHER, /admin/ → ADMIN */
    private static final Map<String, String> PATH_ROLE_MAP =
            Map.of(
    ...
    private boolean isAccessTokenRevoked(Claims claims) {
        ...
        return db.exists(
                "select 1 from access_token_blacklist where jti=? and expires_at > now()", jti);
    }
    ...
    private void writeError(
            ...
            throws IOException {
        String traceId =
                request.getAttribute(TraceFilter.TRACE_ID) == null
                        ? null
        ...
        response.getWriter()
                .write(objectMapper.writeValueAsString(ApiResponse.error(errorCode, traceId)));
    }
}
