...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleIllegalArgument(
        ...
        return ResponseEntity.badRequest()
                .body(
                        ApiResponse.error(
                                ErrorCode.VALIDATION_FIELD, ex.getMessage(), trace(request)));
    }
    ...
    public ResponseEntity<ApiResponse> handleTypeMismatch(
        ...
        return ResponseEntity.badRequest()
                .body(ApiResponse.error(ErrorCode.VALIDATION_PARAM, trace(request)));
    }
    ...
    public ResponseEntity<ApiResponse> handleNotFound(
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(
                        ApiResponse.error(
                                ErrorCode.RESOURCE_NOT_FOUND, ex.getMessage(), trace(request)));
    }
    ...
    public ResponseEntity<ApiResponse> handleSecurity(
    ...
    public ResponseEntity<ApiResponse> handleConflict(
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(
                        ApiResponse.error(
                                ErrorCode.RESOURCE_CONFLICT, ex.getMessage(), trace(request)));
    }

    @ExceptionHandler(DependencyException.class)
    public ResponseEntity<ApiResponse> handleDependency(
    ...
    public ResponseEntity<ApiResponse> handleValidation(
        ...
        String message =
                ex.getBindingResult().getFieldErrors().stream()
                        ...
                        .orElse("参数错误");
        return ResponseEntity.badRequest()
                .body(ApiResponse.error(ErrorCode.VALIDATION_FIELD, message, trace(request)));
    }
    ...
    public ResponseEntity<ApiResponse> handleConstraintViolation(
        ...
        String message =
                ex.getConstraintViolations().stream()
                        ...
                        .orElse("参数错误");
        return ResponseEntity.badRequest()
                .body(ApiResponse.error(ErrorCode.VALIDATION_PARAM, message, trace(request)));
    }
