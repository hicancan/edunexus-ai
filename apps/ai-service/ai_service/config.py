...
class Settings:
    ...
    ollama_structured_model: str
    ollama_lesson_plan_model: str
    ...
    python_runner: str
    chat_rag_timeout_seconds: float
    wrong_analysis_timeout_seconds: float
    ai_question_timeout_seconds: float
    lesson_plan_timeout_seconds: float
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        gemini_structured_model=os.getenv("GEMINI_STRUCTURED_MODEL", "gemini-2.0-flash"),
