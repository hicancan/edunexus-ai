...
class RagChatServicer(RagChatServiceServicer):
    ...
    async def _prepare_rag_context(self, request):
        ...
        if not contexts:
            return None, citations, chunk_ids
        ...
        return prompt, citations, chunk_ids
    ...
    async def Chat(self, request, context: grpc.aio.ServicerContext):
        ...
        prompt, citations, chunk_ids = await self._prepare_rag_context(request)
