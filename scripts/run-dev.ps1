...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$PSScriptRoot/../apps/ai-service'; python -m pip install -r requirements.txt; python -m uvicorn main:app --host 0.0.0.0 --port 8000"
